...
/**
 * @brief Inicializa o controlador ADC e configura o pino PA06 para uso com o ADC.
 */
...
/**
 * @brief Inicializa o controlador USART (configura os pinos PA04 e PA05 para uso com USART).
 */
...
/**
 * @brief Inicializa o clock para o módulo SERCOM0. Geralmente é usado para comunicação serial no microcontrolador
 */
...
/**
 * @brief Inicializa o módulo de comunicação USART (Universal Synchronous and Asynchronous Receiver-Transmitter) usando o SERCOM0.
 */
...
/**
 * @brief Inicializa o controlador I2C (configura os pinos PA16 e PA17 para uso com I2C).
 */
...
/**
 * @brief Inicializa o clock para o módulo SERCOM1.
 */
...
/**
 * @brief Inicializa o controlador de comunicação I2C usando o módulo SERCOM1.
 */
...
/**
 * @brief Inicializa o sistema, configurando o microcontrolador e chamando as funções de inicialização dos controladores.
 */
